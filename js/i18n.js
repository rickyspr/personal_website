...
(function () {
    ...
    var EN = {
        ...
        'pers.fav.city': '<strong>City:</strong> Prague 🇨🇿',
        'pers.fav.food': '<strong>Food:</strong> Pasta pesto (quick + student-friendly)',
        ...
        'pers.goal1.title': '🏃 Run a marathon',
        'pers.goal1.desc': "I'm training to run the <b>ADIDAS STOCKHOLM MARATHON 2026</b>.",
        ...
        'pers.goal3.desc': 'I dream of studying a semester in another country, preferably in Europe. I think it would be very educational and a fantastic experience.',
